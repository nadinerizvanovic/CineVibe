...
Widget _modernDrawerTile(
  ...
  if (label == 'Business Report') {
  ...
  } else if (label == 'Screenings') {
    isSelected =
        currentRoute == 'ScreeningListScreen' ||
        currentRoute == 'ScreeningDetailsScreen';
    ...
    isSelected =
        currentRoute == 'MovieListScreen' ||
        currentRoute == 'MovieDetailsScreen' ||
