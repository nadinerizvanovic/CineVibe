...
import 'package:cinevibe_desktop/screens/category_details_screen.dart';
      ...
      child: Column(
        children: [
          BaseTableDesign(
            ...
            emptySubtext: "Try adjusting your search criteria or add a new category to get started.",
          ),
          SizedBox(height: 30),
          BasePagination(
